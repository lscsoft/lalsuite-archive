...
/usr/bin/time -p --output=timing-$HASH.txt ./GenerateSimulation --approximant SEOBNRv3 --spin1x 0 --spin1y 0 --spin1z 0.8 --spin2x 0.5 --spin2y 0 --spin2z 0.0 --m1 40 --m2 30 --outname simV3-$HASH.out --f-min 10 --distance 1 --inclination 0 --sample-rate 2048 --domain TD >simV3-$HASH-times.txt
