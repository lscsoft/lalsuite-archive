	...
	)
{
    ...
    {  //   fprintf(stdout,"Setting Struct %s\n","Entered");
...
domega  =-3.0* (params->Fnewt/params->dEdvnewt) * v11 *(((( 1. + v * v * (  params->Fcoeff[2]
    ...
    dvalues[0]    = ds   ; dvalues[1]     = domega;
    dvalues[2]    = 0.0; dvalues[3]     = 0.0 ; dvalues[4]    = 0.0;
    dvalues[5]    = 0.0; dvalues[6]     = 0.0  ; dvalues[7]    = 0.0 ;
    dvalues[8]    = 0.0 ; dvalues[9]     = 0.0  ; dvalues[10]   = 0.0 ;
    dvalues[11]   = 0.0 ; dvalues[12]    = 0.0  ; dvalues[13]   = 0.0 ;
   // fprintf(stdout,"dval\n%f",dvalues[1]);
    return GSL_SUCCESS;
}
