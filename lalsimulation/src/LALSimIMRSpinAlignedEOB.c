...
THIS CODE DOES NOT COMPLY WITH THE LAL SPECIFICATION
(NO FILE I/O, NO PRINTF, NO ABORT, ETC.)
DO NOT ENABLE UNTIL IT HAS BEEN CLEANED UP.
...
// FIXME WHY WAS THERE AN ABORT HERE???
//abort();
