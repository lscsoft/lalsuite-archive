...
static int XLALSimInspiralSpinTaylorTestStoppingTest(double t,
	const double values[], double dvalues[], void *mparams);
static int XLALSimInspiralSpinTaylorT4TestDerivatives(double t,
	const double values[], double dvalues[], void *mparams);
static int XLALSimInspiralSpinTaylorT4TestSetup(
...
static int XLALSimInspiralSpinTaylorTestDriver(REAL8TimeSeries **hplus,
...
static int XLALSimInspiralSpinTaylorTestPNEvolveOrbitIrregularIntervals(
...
static int XLALSimInspiralSpinTaylorTestDriverFourier(
 ...
 */
int XLALSimInspiralSpinTaylorTestPNEvolveOrbit(
	...
	)
{
    ...
    if( approx == SpinTaylorT4Test )
    {
        ...
        XLALSimInspiralSpinTaylorT4TestSetup(&paramsT4, m1, m2, fStart, fEnd,
                lambda1, lambda2, quadparam1, quadparam2, spinO, tideO, phaseO, extraParams);
        params = (void *) &paramsT4;
    }
    /*
    else if( approx == SpinTaylorT2Test )
    {
      ...
      //params = (void *) &paramsT2;
        XLALPrintError("XLAL Error - %s: SpinTaylorT2Test not implemented yet!\n",
                __func__);
        XLAL_ERROR(XLAL_EINVAL);
    }
    else if( approx == SpinTaylorT1Test )
    {
        ...
        XLALPrintError("XLAL Error - %s: SpinTaylorT1Test not implemented yet!\n",
                __func__);
        XLAL_ERROR(XLAL_EINVAL);
    }
    */
    ...
    {
        XLALPrintError("XLAL Error - %s: Approximant must be one of SpinTaylorT1Test, SpinTaylorT2Test, SpinTaylorT4Test, but %i provided\n",
                __func__, approx);
        XLAL_ERROR(XLAL_EINVAL);
    ...
    if( approx == SpinTaylorT4Test )
        integrator = XLALAdaptiveRungeKutta4Init(LAL_NUM_ST4_VARIABLES,
                ...
                XLALSimInspiralSpinTaylorTestStoppingTest,
 ...
 */
static int XLALSimInspiralSpinTaylorTestStoppingTest(
	double t,
	const double values[],
	double dvalues[],
	void *mparams
 ...
 */
static int XLALSimInspiralSpinTaylorT4TestDerivatives(
	double t,
	const double values[],
	double dvalues[],
	void *mparams
 ...
 */
int XLALSimInspiralSpinTaylorT4Test(
...
/**
 * Internal driver function to generate any of SpinTaylorT1/T2/T4Test
 */
static int XLALSimInspiralSpinTaylorTestDriver(
	REAL8TimeSeries **hplus,        /**< +-polarization waveform */
	REAL8TimeSeries **hcross,       /**< x-polarization waveform */
	REAL8 phiRef,                   /**< orbital phase at reference pt. */
	REAL8 v0,                       /**< tail gauge term (default = 1) */
	...
	)
{
    ...
    if( fRef < LAL_REAL4_EPS )
    {
        ...
        n = XLALSimInspiralSpinTaylorTestPNEvolveOrbit(&V, &Phi,
    ...
    else /* Start in middle, integrate backward and forward, stitch together */
    {
        ...
        fS = fRef;
        fE = fStart;
        n = XLALSimInspiralSpinTaylorTestPNEvolveOrbit(&V1, &Phi1,
        ...
        fS = fRef;
        fE = 0.;
        n = XLALSimInspiralSpinTaylorTestPNEvolveOrbit(&V2, &Phi2,
...
//         sgn = 1;
    ...
    {
      //XLALSimInspiralSpinTaylorTxCoeffs paramsT2;
      //XLALSimInspiralSpinTaylorT2TestSetup(&paramsT2, m1, m2, fStart, fEnd,
      //        lambda1, lambda2, quadparam1, quadparam2, spinO, tideO, phaseO);
      //params = (void *) &paramsT2;
        XLALPrintError("XLAL Error - %s: SpinTaylorT2Test not implemented yet!\n",
                __func__);
    ...
    */
    ...
    /*
      ...
      //integrator = XLALAdaptiveRungeKutta4Init(LAL_NUM_ST4_VARIABLES,
      //        XLALSimInspiralSpinTaylorT2TestDerivatives,
      //        XLALSimInspiralSpinTaylorTestStoppingTest,
      //        LAL_ST4_ABSOLUTE_TOLERANCE, LAL_ST4_RELATIVE_TOLERANCE);
        XLALPrintError("XLAL Error - %s: SpinTaylorT2Test not implemented yet!\n",
                __func__);
    ...
    {
        //integrator = XLALAdaptiveRungeKutta4Init(LAL_NUM_ST4_VARIABLES,
        //        XLALSimInspiralSpinTaylorT1TestDerivatives,
        //        XLALSimInspiralSpinTaylorTestStoppingTest,
        //        LAL_ST4_ABSOLUTE_TOLERANCE, LAL_ST4_RELATIVE_TOLERANCE);
        XLALPrintError("XLAL Error - %s: SpinTaylorT1Test not implemented yet!\n",
                __func__);
        ...
        )
{
    ...
    if( fRef < LAL_REAL4_EPS)
    {
        ...
        fE = 0.;
        /* Evolve the dynamical variables */
        n = XLALSimInspiralSpinTaylorTestPNEvolveOrbitIrregularIntervals(&y,
    ...
    else /* Start in middle, integrate backward and forward, stitch together */
    {
        ...
        fS = fRef;
        fE = fStart;
        n = XLALSimInspiralSpinTaylorTestPNEvolveOrbitIrregularIntervals(&yStart,
        ...
        fS = fRef;
        fE = 0.;
        n = XLALSimInspiralSpinTaylorTestPNEvolveOrbitIrregularIntervals(&yEnd,
                m1, m2, fS, fE, s1x, s1y, s1z, s2x, s2y,
                s2z, lnhatx, lnhaty, lnhatz, e1x, e1y, e1z, lambda1, lambda2,
                quadparam1, quadparam2, spinO, tideO, phaseO, approx, extraParams);
 ...
 *
 */
int XLALSimInspiralSpinTaylorT4TestFourier(
        COMPLEX16FrequencySeries **hplus,        /**< +-polarization waveform */
        COMPLEX16FrequencySeries **hcross,       /**< x-polarization waveform */
        REAL8 fMin,                     /**< minimum frequency of the returned series */
        REAL8 fMax,                     /**< maximum frequency of the returned series */
...
{
    Approximant approx = SpinTaylorT4Test;
    int n = XLALSimInspiralSpinTaylorTestDriverFourier(hplus, hcross, fMin, fMax,
            deltaF, kMax, phiRef, v0,
            m1, m2, fStart, fRef, r, s1x, s1y, s1z, s2x, s2y, s2z,
            lnhatx, lnhaty, lnhatz, e1x, e1y, e1z, lambda1, lambda2,
            quadparam1, quadparam2, spinO, tideO, phaseO, amplitudeO, approx, phiRefAtEnd, extraParams);
