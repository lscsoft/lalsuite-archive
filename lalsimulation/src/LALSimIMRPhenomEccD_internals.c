 ...
 *
 * ADDED: Leading-order eccentricity corrections up to 3PN order in inspiral phase
 * Copyright (C) 2015 Maria Haney, Achamveedu Gopakumar
 *
 ...
 *
 * only declared here, defined in LALSIMIMRPhenomEccD.c (because this c file is "included" like an h file)
 */
extern UsefulPowers POWERS_of_pi;	 // renamed to avoid conflict with IMRPhenomD
                               		 // additional powers in eccentric variant to be defined here later
...
static double PhiInsAnsatzEccInt(double f, UsefulPowers * powers_of_Mf, PhiInsPrefactors * prefactors, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
static double DPhiInsAnsatzEccInt(double ff, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
...
static void ComputeIMRPhenEccDPhaseConnectionCoefficients(IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
static double IMRPhenEccDPhase(double f, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, UsefulPowers *powers_of_f, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
 ...
 * ADDED:
 * Leading-order eccentricity corrections up to 3PN phase order in TaylorF2
 * Defined in LALSimInspiralEccTF2.c
 * (Implementation ignores syntax chanes in IMRPhenomD for the time being)
 */
static double PhiInsAnsatzEccInt(double Mf, UsefulPowers * powers_of_Mf, PhiInsPrefactors * prefactors, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3)
{
	XLAL_CHECK(0 != pn, XLAL_EFAULT, "pn is NULL");
        XLAL_CHECK(0 != pfv19by3, XLAL_EFAULT, "pfv19by3 is NULL");
        XLAL_CHECK(0 != pfv25by3, XLAL_EFAULT, "pfv25by3 is NULL");
        XLAL_CHECK(0 != pfv28by3, XLAL_EFAULT, "pfv28by3 is NULL");
        XLAL_CHECK(0 != pfv31by3, XLAL_EFAULT, "pfv31by3 is NULL");
        XLAL_CHECK(0 != pfv34by3, XLAL_EFAULT, "pfv34by3 is NULL");
        XLAL_CHECK(0 != pfv37by3, XLAL_EFAULT, "pfv37by3 is NULL");
  ...
  // Add leading-order eccentricity corrections up to 3PN phase order
  // (Implementation ignores syntax changes in IMRPhenomD for the time being)
  const double v2 = v * v;
  ...
  double LO_ecc_corr = 0.0;
  LO_ecc_corr += (pfv19by3->v[6] / v19by3 + pfv25by3->v[6] / v25by3 + pfv28by3->v[6] / v28by3
                    + pfv31by3->v[6] / v31by3 + pfv37by3->v[6] / v37by3
                    + pfv19by3->vlogv[6] / v19by3 * logv) * v6;
  LO_ecc_corr += (pfv19by3->v[5] / v19by3 + pfv25by3->v[5] / v25by3
                    + pfv28by3->v[5] / v28by3 + pfv34by3->v[5] / v34by3) * v5;
  LO_ecc_corr += (pfv19by3->v[4] / v19by3 + pfv25by3->v[4] / v25by3
                    + pfv31by3->v[4] / v31by3) * v4;
  LO_ecc_corr += (pfv19by3->v[3] / v19by3 + pfv28by3->v[3] / v28by3) * v3;
  LO_ecc_corr += (pfv19by3->v[2] / v19by3 + pfv25by3->v[2] / v25by3) * v2;
  LO_ecc_corr += pfv19by3->v[0] / v19by3; // * v^0
  LO_ecc_corr /= v5;
 ...
 */
static double DPhiInsAnsatzEccInt(double Mf, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3) {
  double sigma1 = p->sigma1;
  double sigma2 = p->sigma2;
  double sigma3 = p->sigma3;
  double sigma4 = p->sigma4;
  ...
  double D_LO_ecc_corr = 0.0;
  D_LO_ecc_corr += (-16./3. * pfv19by3->v[6] / v19by3 - 22./3. * pfv25by3->v[6] / v25by3 - 25./3. * pfv28by3->v[6] / v28by3
              		- 28./3. * pfv31by3->v[6] / v31by3 - 34./3. * pfv37by3->v[6] / v37by3
              		+ (-16./3. * logv + 1.) * pfv19by3->vlogv[6] / v19by3) * v6;
  D_LO_ecc_corr += (-19./3. * pfv19by3->v[5] / v19by3 - 25./3. * pfv25by3->v[5] / v25by3
              		- 28./3. * pfv28by3->v[5] / v28by3 - 34./3. * pfv34by3->v[5] / v34by3) * v5;
  D_LO_ecc_corr += (-22./3. * pfv19by3->v[4] / v19by3 - 28./3. * pfv25by3->v[4] / v25by3 - 34./3. * pfv31by3->v[4] / v31by3) * v4;
  D_LO_ecc_corr += (-25./3. * pfv19by3->v[3] / v19by3 - 34./3. * pfv28by3->v[3] / v28by3) * v3;
  D_LO_ecc_corr += (-28./3. * pfv19by3->v[2] / v19by3 - 34./3. * pfv25by3->v[2] / v25by3) * v2;
  D_LO_ecc_corr += -34./3. * pfv19by3->v[0] / v19by3;
  D_LO_ecc_corr /= v8 * 3.0/Pi;

  Dphasing += D_LO_ecc_corr;
...
static void ComputeIMRPhenEccDPhaseConnectionCoefficients(IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3)
{
  ...
  double DPhiIns = DPhiInsAnsatzEccInt(p->fInsJoin, p, pn, pfv19by3, pfv25by3, pfv28by3, pfv31by3, pfv34by3, pfv37by3);
  ...
  p->C1Int = PhiInsAnsatzEccInt(p->fInsJoin, &powers_of_fInsJoin, prefactors, p, pn, pfv19by3, pfv25by3, pfv28by3, pfv31by3, pfv34by3, pfv37by3)
...
static double IMRPhenEccDPhase(double f, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, UsefulPowers *powers_of_f, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3)
{
  ...
  if (!StepFunc_boolean(f, p->fInsJoin))	// Inspiral range
  {
	  double PhiIns = PhiInsAnsatzEccInt(f, powers_of_f, prefactors, p, pn, pfv19by3, pfv25by3, pfv28by3, pfv31by3, pfv34by3, pfv37by3);
	  return PhiIns;
  }
