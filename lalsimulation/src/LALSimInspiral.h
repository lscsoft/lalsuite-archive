...
int XLALSimLorentzInvarianceViolationTerm(COMPLEX16FrequencySeries **hptilde, COMPLEX16FrequencySeries **hctilde, REAL8 m1, REAL8 m2, REAL8 r, REAL8 lambda_a, REAL8 nonGR_alpha, int LIV_A_sign);
