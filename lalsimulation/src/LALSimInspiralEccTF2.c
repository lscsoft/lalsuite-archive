...
#include "LALSimInspiralEccentricPhasingCoeffs.c"
        ...
        )
{
    ...
    /* phasing coefficients of leading-order ecentricity coontributions */
    PNPhasingSeries pfv19by3, pfv25by3, pfv28by3, pfv31by3, pfv34by3, pfv37by3;
    XLALSimInspiralPNPhasing_eccF2(&pfv19by3, &pfv25by3, &pfv28by3, &pfv31by3, &pfv34by3, &pfv37by3, m1, m2, eccentricity, f_min);
	...
	/* Eccentric corrections to non-spin terms in reference phasing */
        /* orders of v_ref in leading-order eccentricity corrections */
        const REAL8 v19by3ref = pow(vref, 19./3.);	/* v_ref^(-19/3) */
        const REAL8 v25by3ref = v19by3ref * v2ref;	/* v_ref^(-25/3) */
        const REAL8 v28by3ref = v19by3ref * v3ref;	/* v_ref^(-28/3) */
        const REAL8 v31by3ref = v19by3ref * v4ref;	/* v_ref^(-31/3) */
        const REAL8 v34by3ref = v19by3ref * v5ref;	/* v_ref^(-34/3) */
        const REAL8 v37by3ref = v19by3ref * v6ref;	/* v_ref^(-37/3) */
        ref_phasing += pfe7 * v7ref; /* 3.5PN e0^2 corrections (ZERO) */
        ...
        ref_phasing += pfe1 * vref; /* 0.5PN e0^2 corrections (ZERO by default) */
    ...
    for (i = 0; i < freqs->length; i++) {
        ...
        /* Eccentric corrections to non-spin terms in phasing */
        /* orders of v in leading-order eccentricity corrections */
        const REAL8 v19by3 = pow(v, 19./3.);	/* v^(-19/3) */
        const REAL8 v25by3 = v19by3 * v2;    /* v^(-25/3) */
        const REAL8 v28by3 = v19by3 * v3;    /* v^(-28/3) */
        const REAL8 v31by3 = v19by3 * v4;    /* v^(-31/3) */
        const REAL8 v34by3 = v19by3 * v5;    /* v^(-34/3) */
        const REAL8 v37by3 = v19by3 * v6;    /* v^(-37/3) */

        phasing += pfe7 * v7; /* 3.5PN e0^2 corrections (ZERO) */
        ...
        phasing += pfe1 * v; /* 0.5PN e0^2 corrections (ZERO by default) */
...
/**
 * Waveform generator for eccentricity-corrected variant 'EccTF2' of TaylorF2
 */
/**
 ...
 *
 * See arXiv:1602.03081 for eccentricity corrections
 *
        ...
        )
{
    ...
    ret = XLALSimInspiralEccTF2Core(&htilde, freqs, phi_ref, m1_SI, m2_SI,
                                      S1z, S2z, f_ref, shft, r, eccentricity, fStart, p);
