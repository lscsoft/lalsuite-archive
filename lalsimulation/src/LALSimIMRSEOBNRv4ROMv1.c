...
/**
 * @addtogroup LALSimIMRSEOBNRv4ROMv1_c
 *
 * \author Michael Puerrer
 *
 * \brief C code for SEOBNRv4 reduced order model (version 1)
 ...
 */
int XLALSimIMRSEOBNRv4ROMv1FrequencySequence(
 ...
 */
int XLALSimIMRSEOBNRv4ROMv1TimeOfFrequency(
 ...
 */
int XLALSimIMRSEOBNRv4ROMv1FrequencyOfTime(
