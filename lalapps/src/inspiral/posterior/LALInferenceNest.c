...
//(--tdlike)\tUse time domain likelihood.\n";
  ...
  ppt=LALInferenceGetProcParamVal(commandLine,"--approx");
  if(ppt) {
    if(!strcmp("PrincipalCompBBH",ppt->value) || !strcmp("PrincipalComp",ppt->value) || !strcmp("SineGaussianF",ppt->value) || !strcmp("SineGaussian",ppt->value)|| !strcmp("Gaussian",ppt->value)|| !strcmp("GaussianF",ppt->value) || !strcmp("DampedSinusoid",ppt->value)|| !strcmp("DampedSinusoidF",ppt->value)){
      ...
      initModelFunc=&LALInferenceInitModelReviewEvidence_banana;
	    ...
	    initModelFunc=&LALInferenceInitBurstModel;
            ...
            initModelFunc=&LALInferenceInitPrincipalCompModel;
             ...
             fprintf(stdout,"--- Calling PrincipalCompBBH init function \n");
            initModelFunc=&LALInferenceInitPrincipalCompModelBBH;
        }
	else{
