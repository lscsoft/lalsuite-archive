...
struct gengetopt_args_info
{
  ...
  char * sky_grid_arg;	/**< @brief sky grid type (arcsin, plain_rectangular, sin_theta) (default='targeted_rectangular').  */
  ...
  double skymap_resolution_arg;	/**< @brief skymap resolution in radians (default='1e-6').  */
  char * skymap_resolution_orig;	/**< @brief skymap resolution in radians original value given at command line.  */
  const char *skymap_resolution_help; /**< @brief skymap resolution in radians help description.  */
  ...
  int job_size_arg;	/**< @brief size of job for multi-threaded operation (default='5').  */
  char * job_size_orig;	/**< @brief size of job for multi-threaded operation original value given at command line.  */
  const char *job_size_help; /**< @brief size of job for multi-threaded operation help description.  */
  ...
  double coherence_length_arg;	/**< @brief coherence length of input SFTs in seconds (default='4.0').  */
  char * coherence_length_orig;	/**< @brief coherence length of input SFTs in seconds original value given at command line.  */
  const char *coherence_length_help; /**< @brief coherence length of input SFTs in seconds help description.  */
  ...
  char * algorithm_arg;	/**< @brief analysis algorithm to use (default='plain_loose').  */
  char * algorithm_orig;	/**< @brief analysis algorithm to use original value given at command line.  */
  const char *algorithm_help; /**< @brief analysis algorithm to use help description.  */
  ...
  double focus_f0_arg;	/**< @brief focus computation on this frequency (Hz).  */
  char * focus_f0_orig;	/**< @brief focus computation on this frequency (Hz) original value given at command line.  */
  const char *focus_f0_help; /**< @brief focus computation on this frequency (Hz) help description.  */
  ...
  double focus_f0_useful_fraction_arg;	/**< @brief fraction of full frequency band to search (default='0.68').  */
  char * focus_f0_useful_fraction_orig;	/**< @brief fraction of full frequency band to search original value given at command line.  */
  const char *focus_f0_useful_fraction_help; /**< @brief fraction of full frequency band to search help description.  */
  ...
  int fake_injection_window_arg;	/**< @brief compute this number of frequency bins to the left and right of the central frequency (default='2').  */
  ...
  int dump_fft_data_arg;	/**< @brief Output fft (default='0').  */
  char * dump_fft_data_orig;	/**< @brief Output fft original value given at command line.  */
  const char *dump_fft_data_help; /**< @brief Output fft help description.  */
  ...
  unsigned int job_size_given ;	/**< @brief Whether job-size was given.  */
  ...
  unsigned int coherence_length_given ;	/**< @brief Whether coherence-length was given.  */
  ...
  unsigned int focus_f0_useful_fraction_given ;	/**< @brief Whether focus-f0-useful-fraction was given.  */
  ...
  unsigned int dump_fft_data_given ;	/**< @brief Whether dump-fft-data was given.  */
