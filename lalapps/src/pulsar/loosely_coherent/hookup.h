...
void verify_whole_sky_AM_response(INT64 *gps, double coherence_time, char *detector, long count, float orientation,  SKY_GRID *grid, float *coeffs_plus, char *name);
