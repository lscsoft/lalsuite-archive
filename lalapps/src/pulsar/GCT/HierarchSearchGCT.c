...
void UpdateSemiCohToplist( LALStatus *status, toplist_t *list1, toplist_t *list2, FineGrid *in, REAL8 f1dot_fg, REAL8 f2dot_fg, UsefulStageVariables *usefulparams );
	  ...
	  if ( uvar_computeLV )
	      ...
	      if ( uvar_computeLV )
              ...
              if( uvar_semiCohToplist ) {
                ...
                LAL_CALL( UpdateSemiCohToplist(&status, semiCohToplist, semiCohToplist2, &finegrid, f1dot_fg, f2dot_fg, &usefulParams), &status);
              }
