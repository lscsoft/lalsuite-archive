...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->dump_sftv2_help = gengetopt_args_info_help[24] ;
  ...
  args_info->doppler_multiplier_help = gengetopt_args_info_help[35] ;
  args_info->spindown_start_time_help = gengetopt_args_info_help[36] ;
  args_info->frequency_offset_help = gengetopt_args_info_help[37] ;
  args_info->spindown_start_help = gengetopt_args_info_help[38] ;
  args_info->spindown_step_help = gengetopt_args_info_help[39] ;
  args_info->spindown_count_help = gengetopt_args_info_help[40] ;
  args_info->fdotdot_help = gengetopt_args_info_help[41] ;
  args_info->orientation_help = gengetopt_args_info_help[42] ;
  args_info->nlinear_polarizations_help = gengetopt_args_info_help[43] ;
  args_info->no_demodulation_help = gengetopt_args_info_help[44] ;
  args_info->no_decomposition_help = gengetopt_args_info_help[45] ;
  args_info->no_candidates_help = gengetopt_args_info_help[46] ;
  args_info->no_am_response_help = gengetopt_args_info_help[47] ;
  args_info->no_secondary_skymaps_help = gengetopt_args_info_help[48] ;
  args_info->averaging_mode_help = gengetopt_args_info_help[49] ;
  args_info->subtract_background_help = gengetopt_args_info_help[50] ;
  args_info->do_cutoff_help = gengetopt_args_info_help[51] ;
  args_info->filter_lines_help = gengetopt_args_info_help[52] ;
  args_info->ks_test_help = gengetopt_args_info_help[53] ;
  args_info->compute_betas_help = gengetopt_args_info_help[54] ;
  args_info->upper_limit_comp_help = gengetopt_args_info_help[55] ;
  args_info->lower_limit_comp_help = gengetopt_args_info_help[56] ;
  args_info->write_dat_help = gengetopt_args_info_help[57] ;
  args_info->write_png_help = gengetopt_args_info_help[58] ;
  args_info->dump_points_help = gengetopt_args_info_help[59] ;
  args_info->dump_candidates_help = gengetopt_args_info_help[60] ;
  args_info->focus_ra_help = gengetopt_args_info_help[61] ;
  args_info->focus_dec_help = gengetopt_args_info_help[62] ;
  args_info->focus_radius_help = gengetopt_args_info_help[63] ;
  args_info->only_large_cos_help = gengetopt_args_info_help[64] ;
  args_info->fake_linear_help = gengetopt_args_info_help[66] ;
  args_info->fake_circular_help = gengetopt_args_info_help[67] ;
  args_info->fake_ref_time_help = gengetopt_args_info_help[68] ;
  args_info->fake_ra_help = gengetopt_args_info_help[69] ;
  args_info->fake_dec_help = gengetopt_args_info_help[70] ;
  args_info->fake_iota_help = gengetopt_args_info_help[71] ;
  args_info->fake_psi_help = gengetopt_args_info_help[72] ;
  args_info->fake_phi_help = gengetopt_args_info_help[73] ;
  args_info->fake_spindown_help = gengetopt_args_info_help[74] ;
  args_info->fake_strain_help = gengetopt_args_info_help[75] ;
  args_info->fake_freq_help = gengetopt_args_info_help[76] ;
  args_info->snr_precision_help = gengetopt_args_info_help[77] ;
  args_info->max_candidates_help = gengetopt_args_info_help[78] ;
  args_info->min_candidate_snr_help = gengetopt_args_info_help[79] ;
  args_info->output_initial_help = gengetopt_args_info_help[80] ;
  args_info->output_optimized_help = gengetopt_args_info_help[81] ;
  args_info->output_cache_help = gengetopt_args_info_help[82] ;
