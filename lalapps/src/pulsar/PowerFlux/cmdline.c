...
const char *gengetopt_args_info_help[] = {
  ...
  "      --flat-output=STRING      output directory to contain all files, with no\n                                  subdirectories (for globus condor)",
  ...
  "      --side-cut=INT            number of extra bins to load to accomodate\n                                  doppler shifts and spindown",
  "      --sft-coherence-time=DOUBLE\n                                coherence time of input SFTs\n                                  (default=`1800.0')",
  "      --extra-side-cut=INT      number of extra bins to load in addition to\n                                  side-cut computed automatically\n                                  (default=`0')",
  ...
  "      --fdotdot_step=DOUBLE     second frequency derivative step size\n                                  (default=`0.0')",
  "      --fdotdot_count=INT       second frequency derivative step count\n                                  (default=`1')",
  "      --freq-modulation-depth=DOUBLE\n                                depth of additional sinusoidal frequency\n                                  modulation in Hz  (default=`0.0')",
  "      --freq-modulation-freq=DOUBLE\n                                frequency of additional sinusoidal frequency\n                                  modulation  (default=`1.0')",
  "      --freq-modulation-phase=DOUBLE\n                                phase of additional sinusoidal frequency\n                                  modulation  (default=`0.0')",
  "      --freq-modulation-depth-step=DOUBLE\n                                depth of additional sinusoidal frequency\n                                  modulation step  (default=`0.0')",
  "      --freq-modulation-freq-step=DOUBLE\n                                frequency of additional sinusoidal frequency\n                                  modulation step  (default=`0.0')",
  "      --freq-modulation-phase-step=DOUBLE\n                                phase of additional sinusoidal frequency\n                                  modulation step  (default=`0.0')",
  "      --freq-modulation-depth-count=INT\n                                depth of additional sinusoidal frequency\n                                  modulation count  (default=`1')",
  "      --freq-modulation-freq-count=INT\n                                frequency of additional sinusoidal frequency\n                                  modulation count  (default=`1')",
  "      --freq-modulation-phase-count=INT\n                                phase of additional sinusoidal frequency\n                                  modulation count  (default=`1')",
  ...
  "      --binary-template-ngroup=INT\n                                maximum number of input templates in a group\n                                  (default=`5')",
  "\n Group: injection",
  ...
  "      --fake-ra=DOUBLE          RA of fake signal to inject  (default=`0.0')",
  ...
  "      --fake-fdotdot=DOUBLE     second derivative of fake signal to inject\n                                  (default=`0.0')",
  "      --fake-strain=DOUBLE      amplitude of fake signal to inject\n                                  (default=`0.0')",
  "      --fake-freq=DOUBLE        frequency of fake signal to inject",
  "      --fake-dInv=DOUBLE        inverse distance to source of fake signal in\n                                  seconds  (default=`0.0')",
  ...
  "      --averaged-polarization=INT\n                                Include an approximate average polarization,\n                                  like F-statistics  (default=`1')",
  ...
  "      --compute-cross-terms=INT compute imaginary cross terms in loosely\n                                  coherent search  (default=`0')",
  "      --mixed-dataset-only=INT  use only mixed-dataset (ifo) terms in loosely\n                                  coherent sum  (default=`0')",
  ...
  "      --sse=INT                 use hand-coded SSE optimizations  (default=`1')",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->sft_coherence_time_given = 0 ;
  args_info->extra_side_cut_given = 0 ;
  ...
  args_info->fdotdot_step_given = 0 ;
  args_info->fdotdot_count_given = 0 ;
  args_info->freq_modulation_depth_given = 0 ;
  args_info->freq_modulation_freq_given = 0 ;
  args_info->freq_modulation_phase_given = 0 ;
  args_info->freq_modulation_depth_step_given = 0 ;
  args_info->freq_modulation_freq_step_given = 0 ;
  args_info->freq_modulation_phase_step_given = 0 ;
  args_info->freq_modulation_depth_count_given = 0 ;
  args_info->freq_modulation_freq_count_given = 0 ;
  args_info->freq_modulation_phase_count_given = 0 ;
  ...
  args_info->binary_template_ngroup_given = 0 ;
  ...
  args_info->fake_fdotdot_given = 0 ;
  ...
  args_info->averaged_polarization_given = 0 ;
  ...
  args_info->mixed_dataset_only_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->flat_output_arg = NULL;
  args_info->flat_output_orig = NULL;
  ...
  args_info->sft_coherence_time_arg = 1800.0;
  args_info->sft_coherence_time_orig = NULL;
  args_info->extra_side_cut_arg = 0;
  args_info->extra_side_cut_orig = NULL;
  ...
  args_info->fdotdot_step_arg = 0.0;
  args_info->fdotdot_step_orig = NULL;
  args_info->fdotdot_count_arg = 1;
  args_info->fdotdot_count_orig = NULL;
  args_info->freq_modulation_depth_arg = 0.0;
  args_info->freq_modulation_depth_orig = NULL;
  args_info->freq_modulation_freq_arg = 1.0;
  args_info->freq_modulation_freq_orig = NULL;
  args_info->freq_modulation_phase_arg = 0.0;
  args_info->freq_modulation_phase_orig = NULL;
  args_info->freq_modulation_depth_step_arg = 0.0;
  args_info->freq_modulation_depth_step_orig = NULL;
  args_info->freq_modulation_freq_step_arg = 0.0;
  args_info->freq_modulation_freq_step_orig = NULL;
  args_info->freq_modulation_phase_step_arg = 0.0;
  args_info->freq_modulation_phase_step_orig = NULL;
  args_info->freq_modulation_depth_count_arg = 1;
  args_info->freq_modulation_depth_count_orig = NULL;
  args_info->freq_modulation_freq_count_arg = 1;
  args_info->freq_modulation_freq_count_orig = NULL;
  args_info->freq_modulation_phase_count_arg = 1;
  args_info->freq_modulation_phase_count_orig = NULL;
  ...
  args_info->binary_template_ngroup_arg = 5;
  args_info->binary_template_ngroup_orig = NULL;
  ...
  args_info->fake_fdotdot_arg = 0.0;
  args_info->fake_fdotdot_orig = NULL;
  args_info->fake_strain_arg = 0.0;
  args_info->fake_strain_orig = NULL;
  args_info->fake_freq_orig = NULL;
  args_info->fake_dInv_arg = 0.0;
  ...
  args_info->averaged_polarization_arg = 1;
  args_info->averaged_polarization_orig = NULL;
  ...
  args_info->statistics_function_arg = gengetopt_strdup ("universal");
  ...
  args_info->compute_cross_terms_arg = 0;
  args_info->compute_cross_terms_orig = NULL;
  args_info->mixed_dataset_only_arg = 0;
  args_info->mixed_dataset_only_orig = NULL;
  ...
  args_info->sse_arg = 1;
  args_info->sse_orig = NULL;
  args_info->extra_phase_arg = NULL;
  args_info->extra_phase_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->flat_output_help = gengetopt_args_info_help[27] ;
  args_info->ephemeris_path_help = gengetopt_args_info_help[28] ;
  args_info->earth_ephemeris_help = gengetopt_args_info_help[29] ;
  args_info->sun_ephemeris_help = gengetopt_args_info_help[30] ;
  args_info->first_bin_help = gengetopt_args_info_help[31] ;
  args_info->nbins_help = gengetopt_args_info_help[32] ;
  args_info->side_cut_help = gengetopt_args_info_help[33] ;
  args_info->sft_coherence_time_help = gengetopt_args_info_help[34] ;
  args_info->extra_side_cut_help = gengetopt_args_info_help[35] ;
  args_info->expected_timebase_help = gengetopt_args_info_help[36] ;
  args_info->hist_bins_help = gengetopt_args_info_help[37] ;
  args_info->detector_help = gengetopt_args_info_help[38] ;
  args_info->doppler_multiplier_help = gengetopt_args_info_help[39] ;
  args_info->dInv_help = gengetopt_args_info_help[40] ;
  args_info->spindown_start_time_help = gengetopt_args_info_help[41] ;
  args_info->frequency_offset_help = gengetopt_args_info_help[42] ;
  args_info->spindown_start_help = gengetopt_args_info_help[43] ;
  args_info->spindown_step_help = gengetopt_args_info_help[44] ;
  args_info->spindown_count_help = gengetopt_args_info_help[45] ;
  args_info->fdotdot_help = gengetopt_args_info_help[46] ;
  args_info->fdotdot_step_help = gengetopt_args_info_help[47] ;
  args_info->fdotdot_count_help = gengetopt_args_info_help[48] ;
  args_info->freq_modulation_depth_help = gengetopt_args_info_help[49] ;
  args_info->freq_modulation_freq_help = gengetopt_args_info_help[50] ;
  args_info->freq_modulation_phase_help = gengetopt_args_info_help[51] ;
  args_info->freq_modulation_depth_step_help = gengetopt_args_info_help[52] ;
  args_info->freq_modulation_freq_step_help = gengetopt_args_info_help[53] ;
  args_info->freq_modulation_phase_step_help = gengetopt_args_info_help[54] ;
  args_info->freq_modulation_depth_count_help = gengetopt_args_info_help[55] ;
  args_info->freq_modulation_freq_count_help = gengetopt_args_info_help[56] ;
  args_info->freq_modulation_phase_count_help = gengetopt_args_info_help[57] ;
  args_info->orientation_help = gengetopt_args_info_help[58] ;
  args_info->nlinear_polarizations_help = gengetopt_args_info_help[59] ;
  args_info->no_demodulation_help = gengetopt_args_info_help[60] ;
  args_info->no_decomposition_help = gengetopt_args_info_help[61] ;
  args_info->no_candidates_help = gengetopt_args_info_help[62] ;
  args_info->no_am_response_help = gengetopt_args_info_help[63] ;
  args_info->no_secondary_skymaps_help = gengetopt_args_info_help[64] ;
  args_info->averaging_mode_help = gengetopt_args_info_help[65] ;
  args_info->subtract_background_help = gengetopt_args_info_help[66] ;
  args_info->do_cutoff_help = gengetopt_args_info_help[67] ;
  args_info->filter_lines_help = gengetopt_args_info_help[68] ;
  args_info->ks_test_help = gengetopt_args_info_help[69] ;
  ...
  args_info->binary_template_ngroup_help = gengetopt_args_info_help[85] ;
  ...
  args_info->divert_ul_rel_help = gengetopt_args_info_help[113] ;
  args_info->divert_count_limit_help = gengetopt_args_info_help[114] ;
  args_info->divert_ul_count_limit_help = gengetopt_args_info_help[115] ;
  args_info->divert_buffer_size_help = gengetopt_args_info_help[116] ;
  args_info->output_initial_help = gengetopt_args_info_help[117] ;
  args_info->output_optimized_help = gengetopt_args_info_help[118] ;
  args_info->output_cache_help = gengetopt_args_info_help[119] ;
  args_info->progress_update_interval_help = gengetopt_args_info_help[120] ;
  args_info->extended_test_help = gengetopt_args_info_help[121] ;
  args_info->max_sft_report_help = gengetopt_args_info_help[122] ;
  args_info->num_threads_help = gengetopt_args_info_help[123] ;
  args_info->num_threads_env_help = gengetopt_args_info_help[124] ;
  args_info->niota_help = gengetopt_args_info_help[125] ;
  args_info->npsi_help = gengetopt_args_info_help[126] ;
  args_info->averaged_polarization_help = gengetopt_args_info_help[127] ;
  args_info->nfshift_help = gengetopt_args_info_help[128] ;
  args_info->nchunks_help = gengetopt_args_info_help[129] ;
  args_info->nchunks_refinement_help = gengetopt_args_info_help[130] ;
  args_info->min_nchunks_help = gengetopt_args_info_help[131] ;
  args_info->split_ifos_help = gengetopt_args_info_help[132] ;
  args_info->default_dataset_veto_level_help = gengetopt_args_info_help[133] ;
  args_info->default_dataset_veto_spike_level_help = gengetopt_args_info_help[134] ;
  args_info->weight_cutoff_fraction_help = gengetopt_args_info_help[135] ;
  args_info->per_dataset_weight_cutoff_fraction_help = gengetopt_args_info_help[136] ;
  args_info->power_max_median_factor_help = gengetopt_args_info_help[137] ;
  args_info->tmedian_noise_level_help = gengetopt_args_info_help[138] ;
  args_info->summing_step_help = gengetopt_args_info_help[139] ;
  args_info->max_first_shift_help = gengetopt_args_info_help[140] ;
  args_info->statistics_function_help = gengetopt_args_info_help[141] ;
  args_info->confidence_level_help = gengetopt_args_info_help[142] ;
  args_info->x_epsilon_help = gengetopt_args_info_help[143] ;
  args_info->dump_power_sums_help = gengetopt_args_info_help[144] ;
  args_info->compute_skymaps_help = gengetopt_args_info_help[145] ;
  args_info->fine_grid_skymarks_help = gengetopt_args_info_help[146] ;
  args_info->half_window_help = gengetopt_args_info_help[147] ;
  args_info->tail_veto_help = gengetopt_args_info_help[148] ;
  args_info->cache_granularity_help = gengetopt_args_info_help[149] ;
  args_info->diff_shift_granularity_help = gengetopt_args_info_help[150] ;
  args_info->sidereal_group_count_help = gengetopt_args_info_help[151] ;
  args_info->time_group_count_help = gengetopt_args_info_help[152] ;
  args_info->phase_mismatch_help = gengetopt_args_info_help[153] ;
  args_info->bypass_powersum_cache_help = gengetopt_args_info_help[154] ;
  args_info->compute_cross_terms_help = gengetopt_args_info_help[155] ;
  args_info->mixed_dataset_only_help = gengetopt_args_info_help[156] ;
  args_info->preallocate_memory_help = gengetopt_args_info_help[157] ;
  args_info->memory_allocation_retries_help = gengetopt_args_info_help[158] ;
  args_info->sse_help = gengetopt_args_info_help[159] ;
  args_info->extra_phase_help = gengetopt_args_info_help[160] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->flat_output_arg));
  free_string_field (&(args_info->flat_output_orig));
  ...
  free_string_field (&(args_info->sft_coherence_time_orig));
  free_string_field (&(args_info->extra_side_cut_orig));
  ...
  free_string_field (&(args_info->fdotdot_step_orig));
  free_string_field (&(args_info->fdotdot_count_orig));
  free_string_field (&(args_info->freq_modulation_depth_orig));
  free_string_field (&(args_info->freq_modulation_freq_orig));
  free_string_field (&(args_info->freq_modulation_phase_orig));
  free_string_field (&(args_info->freq_modulation_depth_step_orig));
  free_string_field (&(args_info->freq_modulation_freq_step_orig));
  free_string_field (&(args_info->freq_modulation_phase_step_orig));
  free_string_field (&(args_info->freq_modulation_depth_count_orig));
  free_string_field (&(args_info->freq_modulation_freq_count_orig));
  free_string_field (&(args_info->freq_modulation_phase_count_orig));
  ...
  free_string_field (&(args_info->binary_template_ngroup_orig));
  ...
  free_string_field (&(args_info->fake_fdotdot_orig));
  ...
  free_string_field (&(args_info->averaged_polarization_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->flat_output_given)
    write_into_file(outfile, "flat-output", args_info->flat_output_orig, 0);
  ...
  if (args_info->sft_coherence_time_given)
    write_into_file(outfile, "sft-coherence-time", args_info->sft_coherence_time_orig, 0);
  if (args_info->extra_side_cut_given)
    write_into_file(outfile, "extra-side-cut", args_info->extra_side_cut_orig, 0);
  ...
  if (args_info->fdotdot_step_given)
    write_into_file(outfile, "fdotdot_step", args_info->fdotdot_step_orig, 0);
  if (args_info->fdotdot_count_given)
    write_into_file(outfile, "fdotdot_count", args_info->fdotdot_count_orig, 0);
  if (args_info->freq_modulation_depth_given)
    write_into_file(outfile, "freq-modulation-depth", args_info->freq_modulation_depth_orig, 0);
  if (args_info->freq_modulation_freq_given)
    write_into_file(outfile, "freq-modulation-freq", args_info->freq_modulation_freq_orig, 0);
  if (args_info->freq_modulation_phase_given)
    write_into_file(outfile, "freq-modulation-phase", args_info->freq_modulation_phase_orig, 0);
  if (args_info->freq_modulation_depth_step_given)
    write_into_file(outfile, "freq-modulation-depth-step", args_info->freq_modulation_depth_step_orig, 0);
  if (args_info->freq_modulation_freq_step_given)
    write_into_file(outfile, "freq-modulation-freq-step", args_info->freq_modulation_freq_step_orig, 0);
  if (args_info->freq_modulation_phase_step_given)
    write_into_file(outfile, "freq-modulation-phase-step", args_info->freq_modulation_phase_step_orig, 0);
  if (args_info->freq_modulation_depth_count_given)
    write_into_file(outfile, "freq-modulation-depth-count", args_info->freq_modulation_depth_count_orig, 0);
  if (args_info->freq_modulation_freq_count_given)
    write_into_file(outfile, "freq-modulation-freq-count", args_info->freq_modulation_freq_count_orig, 0);
  if (args_info->freq_modulation_phase_count_given)
    write_into_file(outfile, "freq-modulation-phase-count", args_info->freq_modulation_phase_count_orig, 0);
  ...
  if (args_info->binary_template_ngroup_given)
    write_into_file(outfile, "binary-template-ngroup", args_info->binary_template_ngroup_orig, 0);
  ...
  if (args_info->fake_fdotdot_given)
    write_into_file(outfile, "fake-fdotdot", args_info->fake_fdotdot_orig, 0);
  ...
  if (args_info->averaged_polarization_given)
    write_into_file(outfile, "averaged-polarization", args_info->averaged_polarization_orig, 0);
  ...
  if (args_info->mixed_dataset_only_given)
    write_into_file(outfile, "mixed-dataset-only", args_info->mixed_dataset_only_orig, 0);
  ...
  if (args_info->sse_given)
    write_into_file(outfile, "sse", args_info->sse_orig, 0);
  write_multiple_into_file(outfile, args_info->extra_phase_given, "extra-phase", args_info->extra_phase_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->extra_phase_given, args_info->extra_phase_min, args_info->extra_phase_max, "'--extra-phase'"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * extra_phase_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "nbins",	1, NULL, 'n' },
        { "side-cut",	1, NULL, 0 },
        { "sft-coherence-time",	1, NULL, 0 },
        { "extra-side-cut",	1, NULL, 0 },
        ...
        { "fdotdot",	1, NULL, 0 },
        { "fdotdot_step",	1, NULL, 0 },
        { "fdotdot_count",	1, NULL, 0 },
        { "freq-modulation-depth",	1, NULL, 0 },
        { "freq-modulation-freq",	1, NULL, 0 },
        { "freq-modulation-phase",	1, NULL, 0 },
        { "freq-modulation-depth-step",	1, NULL, 0 },
        { "freq-modulation-freq-step",	1, NULL, 0 },
        { "freq-modulation-phase-step",	1, NULL, 0 },
        { "freq-modulation-depth-count",	1, NULL, 0 },
        { "freq-modulation-freq-count",	1, NULL, 0 },
        { "freq-modulation-phase-count",	1, NULL, 0 },
        ...
        { "binary-template-ngroup",	1, NULL, 0 },
        ...
        { "niota",	1, NULL, 0 },
        { "npsi",	1, NULL, 0 },
        { "averaged-polarization",	1, NULL, 0 },
        { "nfshift",	1, NULL, 0 },
        { "nchunks",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* output directory to contain all files, with no subdirectories (for globus condor).  */
          else if (strcmp (long_options[option_index].name, "flat-output") == 0)
          {


            if (update_arg( (void *)&(args_info->flat_output_arg),
                 &(args_info->flat_output_orig), &(args_info->flat_output_given),
                &(local_args_info.flat_output_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "flat-output", '-',
                additional_error))
              goto failure;
          ...
          /* number of extra bins to load to accomodate doppler shifts and spindown.  */
          ...
          /* coherence time of input SFTs.  */
          else if (strcmp (long_options[option_index].name, "sft-coherence-time") == 0)
          {


            if (update_arg( (void *)&(args_info->sft_coherence_time_arg),
                 &(args_info->sft_coherence_time_orig), &(args_info->sft_coherence_time_given),
                &(local_args_info.sft_coherence_time_given), optarg, 0, "1800.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "sft-coherence-time", '-',
                additional_error))
              goto failure;
          ...
          /* number of extra bins to load in addition to side-cut computed automatically.  */
          else if (strcmp (long_options[option_index].name, "extra-side-cut") == 0)
          {


            if (update_arg( (void *)&(args_info->extra_side_cut_arg),
                 &(args_info->extra_side_cut_orig), &(args_info->extra_side_cut_given),
                &(local_args_info.extra_side_cut_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "extra-side-cut", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "expected-timebase") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->expected_timebase_arg),
                ...
                &(local_args_info.expected_timebase_given), optarg, 0, "6", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "expected-timebase", '-',
                additional_error))
              goto failure;
          ...
          /* second frequency derivative step size.  */
          else if (strcmp (long_options[option_index].name, "fdotdot_step") == 0)
          {


            if (update_arg( (void *)&(args_info->fdotdot_step_arg),
                 &(args_info->fdotdot_step_orig), &(args_info->fdotdot_step_given),
                &(local_args_info.fdotdot_step_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "fdotdot_step", '-',
                additional_error))
              goto failure;
          ...
          /* second frequency derivative step count.  */
          else if (strcmp (long_options[option_index].name, "fdotdot_count") == 0)
          {


            if (update_arg( (void *)&(args_info->fdotdot_count_arg),
                 &(args_info->fdotdot_count_orig), &(args_info->fdotdot_count_given),
                &(local_args_info.fdotdot_count_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "fdotdot_count", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "freq-modulation-depth") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_depth_arg),
                 &(args_info->freq_modulation_depth_orig), &(args_info->freq_modulation_depth_given),
                &(local_args_info.freq_modulation_depth_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "freq-modulation-depth", '-',
                additional_error))
              goto failure;

          }
          /* frequency of additional sinusoidal frequency modulation.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-freq") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_freq_arg),
                 &(args_info->freq_modulation_freq_orig), &(args_info->freq_modulation_freq_given),
                &(local_args_info.freq_modulation_freq_given), optarg, 0, "1.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "freq-modulation-freq", '-',
                additional_error))
              goto failure;

          }
          /* phase of additional sinusoidal frequency modulation.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-phase") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_phase_arg),
                 &(args_info->freq_modulation_phase_orig), &(args_info->freq_modulation_phase_given),
                &(local_args_info.freq_modulation_phase_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "freq-modulation-phase", '-',
                additional_error))
              goto failure;

          }
          /* depth of additional sinusoidal frequency modulation step.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-depth-step") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_depth_step_arg),
                 &(args_info->freq_modulation_depth_step_orig), &(args_info->freq_modulation_depth_step_given),
                &(local_args_info.freq_modulation_depth_step_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "freq-modulation-depth-step", '-',
                additional_error))
              goto failure;

          }
          /* frequency of additional sinusoidal frequency modulation step.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-freq-step") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_freq_step_arg),
                 &(args_info->freq_modulation_freq_step_orig), &(args_info->freq_modulation_freq_step_given),
                &(local_args_info.freq_modulation_freq_step_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "freq-modulation-freq-step", '-',
                additional_error))
              goto failure;

          }
          /* phase of additional sinusoidal frequency modulation step.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-phase-step") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_phase_step_arg),
                 &(args_info->freq_modulation_phase_step_orig), &(args_info->freq_modulation_phase_step_given),
                &(local_args_info.freq_modulation_phase_step_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "freq-modulation-phase-step", '-',
                additional_error))
              goto failure;

          }
          /* depth of additional sinusoidal frequency modulation count.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-depth-count") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_depth_count_arg),
                 &(args_info->freq_modulation_depth_count_orig), &(args_info->freq_modulation_depth_count_given),
                &(local_args_info.freq_modulation_depth_count_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "freq-modulation-depth-count", '-',
                additional_error))
              goto failure;

          }
          /* frequency of additional sinusoidal frequency modulation count.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-freq-count") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_freq_count_arg),
                 &(args_info->freq_modulation_freq_count_orig), &(args_info->freq_modulation_freq_count_given),
                &(local_args_info.freq_modulation_freq_count_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "freq-modulation-freq-count", '-',
                additional_error))
              goto failure;

          }
          /* phase of additional sinusoidal frequency modulation count.  */
          else if (strcmp (long_options[option_index].name, "freq-modulation-phase-count") == 0)
          {


            if (update_arg( (void *)&(args_info->freq_modulation_phase_count_arg),
                 &(args_info->freq_modulation_phase_count_orig), &(args_info->freq_modulation_phase_count_given),
                &(local_args_info.freq_modulation_phase_count_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "freq-modulation-phase-count", '-',
                additional_error))
              goto failure;
          ...
          /* maximum number of input templates in a group.  */
          else if (strcmp (long_options[option_index].name, "binary-template-ngroup") == 0)
          {


            if (update_arg( (void *)&(args_info->binary_template_ngroup_arg),
                 &(args_info->binary_template_ngroup_orig), &(args_info->binary_template_ngroup_given),
                &(local_args_info.binary_template_ngroup_given), optarg, 0, "5", ARG_INT,
                check_ambiguity, override, 0, 0,
                "binary-template-ngroup", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "fake-ra") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->fake_ra_arg),
                ...
                &(local_args_info.fake_ra_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "fake-ra", '-',
                additional_error))
              goto failure;
          ...
          /* second derivative of fake signal to inject.  */
          else if (strcmp (long_options[option_index].name, "fake-fdotdot") == 0)
          {


            if (update_arg( (void *)&(args_info->fake_fdotdot_arg),
                 &(args_info->fake_fdotdot_orig), &(args_info->fake_fdotdot_given),
                &(local_args_info.fake_fdotdot_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "fake-fdotdot", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "fake-strain") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->fake_strain_arg),
                ...
                &(local_args_info.fake_strain_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "fake-strain", '-',
                additional_error))
              goto failure;
          ...
          /* inverse distance to source of fake signal in seconds.  */
          else if (strcmp (long_options[option_index].name, "fake-dInv") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->fake_dInv_arg),
                ...
                &(local_args_info.fake_dInv_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "fake-dInv", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "fake-injection-window") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->fake_injection_window_arg),
                ...
                &(local_args_info.fake_injection_window_given), optarg, 0, "5", ARG_INT,
                check_ambiguity, override, 0, 0,
          ...
          else if (strcmp (long_options[option_index].name, "extended-test") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->extended_test_arg),
                ...
                &(local_args_info.extended_test_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "extended-test", '-',
                additional_error))
              goto failure;
          ...
          /* Include an approximate average polarization, like F-statistics.  */
          else if (strcmp (long_options[option_index].name, "averaged-polarization") == 0)
          {


            if (update_arg( (void *)&(args_info->averaged_polarization_arg),
                 &(args_info->averaged_polarization_orig), &(args_info->averaged_polarization_given),
                &(local_args_info.averaged_polarization_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
          ...
          else if (strcmp (long_options[option_index].name, "statistics-function") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->statistics_function_arg),
                ...
                &(local_args_info.statistics_function_given), optarg, 0, "universal", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "statistics-function", '-',
                additional_error))
              goto failure;
          ...
          /* compute imaginary cross terms in loosely coherent search.  */
          else if (strcmp (long_options[option_index].name, "compute-cross-terms") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->compute_cross_terms_arg),
                ...
                &(local_args_info.compute_cross_terms_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "compute-cross-terms", '-',
                additional_error))
              goto failure;
          ...
          /* use only mixed-dataset (ifo) terms in loosely coherent sum.  */
          else if (strcmp (long_options[option_index].name, "mixed-dataset-only") == 0)
          {


            if (update_arg( (void *)&(args_info->mixed_dataset_only_arg),
                 &(args_info->mixed_dataset_only_orig), &(args_info->mixed_dataset_only_given),
                &(local_args_info.mixed_dataset_only_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "mixed-dataset-only", '-',
                additional_error))
              goto failure;
          ...
          /* preallocate this many gigabytes of memory for future usage.  */
          else if (strcmp (long_options[option_index].name, "preallocate-memory") == 0)
          {


            if (update_arg( (void *)&(args_info->preallocate_memory_arg),
                 &(args_info->preallocate_memory_orig), &(args_info->preallocate_memory_given),
          ...
          /* use hand-coded SSE optimizations.  */
          else if (strcmp (long_options[option_index].name, "sse") == 0)
          {


            if (update_arg( (void *)&(args_info->sse_arg),
                 &(args_info->sse_orig), &(args_info->sse_given),
                &(local_args_info.sse_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "sse", '-',
                additional_error))
              goto failure;
          ...
          /* shift data of all datasets matching regexp by this phase (specify in degrees as \".*H1.* 45.3\").  */
          else if (strcmp (long_options[option_index].name, "extra-phase") == 0)
          {

            if (update_multiple_arg_temp(&extra_phase_list,
                &(local_args_info.extra_phase_given), optarg, 0, 0, ARG_STRING,
                "extra-phase", '-',
                additional_error))
              goto failure;
  ...
  update_multiple_arg((void *)&(args_info->extra_phase_arg),
    &(args_info->extra_phase_orig), args_info->extra_phase_given,
    local_args_info.extra_phase_given, 0,
    ARG_STRING, extra_phase_list);

  args_info->config_given += local_args_info.config_given;
  local_args_info.config_given = 0;
  args_info->extra_phase_given += local_args_info.extra_phase_given;
  local_args_info.extra_phase_given = 0;
