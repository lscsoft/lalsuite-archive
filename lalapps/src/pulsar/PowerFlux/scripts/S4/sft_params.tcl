...
foreach {var value} {
	...
	channel "${interferometer}:LSC-STRAIN"
        ...
        frame_library "/scratch4/volodya/${data_set}.${interferometer}.list.${sft_kind}.txt"
	...
	group_regexp {/([0-9]*)-([0-9]*)/.-.._RDS_C01_LX}
	...
	veto_expr {$FLAG_ADC_OVERFLOW | $FLAG_OUT_OF_LOCK | $FLAG_NO_DATA | $FLAG_NO_RDS}
	non_veto_expr {0}
        } {
        global $var
        set $var $value
