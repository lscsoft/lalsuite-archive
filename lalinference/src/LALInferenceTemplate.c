...
/****************************************************************************************/
{
  ...
  UINT4 i=0;
      ...
      XLALSimBurstGaussian(&hplus,&hcross, duration,hrss,eccentricity,polar_angle,IFOdata->timeData->deltaT);
...
/******************************************************************************/
{
  ...
  UINT4 i=0;
    ...
    */
      ...
      XLALSimBurstDampedSinusoid(&hplus,&hcross, Q, centre_frequency,hrss,eccentricity,polar_angle,IFOdata->timeData->deltaT);
...
/*****************************************************/
/* Frequency domain Ringdown (burst) template.       */
/* Signal is (by now?) linearly polarised,           */
/* i.e., the cross-waveform remains zero.            */
/* * * * * * * * * * * * * * * * * * * * * * * * * * */
/* The (plus-) waveform is:                          */
...
/****************************************************************************************/
{
    ...
    COMPLEX16FrequencySeries *hplus=NULL;  /**< +-polarization waveform */
    COMPLEX16FrequencySeries *hcross=NULL; /**< x-polarization waveform */
    REAL8 Q, centre_frequency,hrss,alpha; //phi;
    UINT4 i=0;
    ...
    XLALSimBurstDampedSinusoidF(&hplus,&hcross, Q, centre_frequency,hrss,alpha,IFOdata->freqData->deltaF,IFOdata->timeData->deltaT);
