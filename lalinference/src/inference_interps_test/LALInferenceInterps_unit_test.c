...
int free_manifold(struct twod_waveform_interpolant_manifold*);
...
struct twod_waveform_interpolant_manifold *XLALInferenceCreateInterpManifold(double, double, double, double, double);
