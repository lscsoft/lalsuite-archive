...
\subsubsection*{Structure \texttt{FindChirpSubBank}}
\idx[Type]{FindChirpSubBank}

\noindent This structure provides contains subbanks for the template bank
veto.
</lalLaTeX>
#endif
/* <lalVerbatim> */
...
<lalLaTeX>
\begin{description}
\item[\texttt{InspiralTemplate *bankHead}] A pointer to an 
\texttt{InspiralTemplate} structure which is the head of linked list of
templates.

\item[\texttt{struct tagFindChirpSubBank *next}] The next structure in
the linked list.
\end{description}
...
/* <lalVerbatim> */
typedef struct
tagFindChirpSubBankData
{
  COMPLEX8Vector                       *qVec;
  FindChirpTemplate                    *fcTmplt;
  struct tagFindChirpSubBankData       *next;
}
FindChirpSubBankData;
/* </lalVerbatim> */
#if 0
<lalLaTeX>
\begin{description}
