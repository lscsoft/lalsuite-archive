...
{ /* </lalVerbatim> */
  ...
  //p = malloc( allocsz( n ) );
  printf("CudaHostAlloc= %d", cudaHostAlloc( p, n, cudaHostAllocDefault ));
...
{ /* </lalVerbatim> */
  ...
  //p  = malloc( allocsz( sz ) );
  printf("CudaHostAlloc= %d", cudaHostAlloc( p, sz, cudaHostAllocDefault ));
...
{ /* </lalVerbatim> */
  ...
  //{
    //p = malloc( allocsz( n ) );
    printf("CudaHostAlloc= %d", cudaHostAlloc( q, n , cudaHostAllocDefault ));
