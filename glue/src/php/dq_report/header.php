...
For an active flag, it prints the start and end tiem of the segment to which the active flag belongs. <br/><br/>
...
ve at that time.<br/>
For an active flag, it prints the start and end tiem of the segment to which the
