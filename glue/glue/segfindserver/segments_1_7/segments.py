#
# This is CVS version 1.7 of the segments.py module which provides the old
# segment class definitions so that the LSCsegFindServer can be backwards 
# compatible with clients who use the old segments module.
#
# IT SHOULD NOT BE CHANGED, EXTENDED OR USED IN ANY OTHER CODE.
#
...
__date__ = "Date: 2005/03/03 03:11:39"
