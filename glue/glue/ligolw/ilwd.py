...
class inspiral_ilwdchar(long):
	"""
	Special ilwdchar-like class written to allow files generated by
	lalapps_thinca to be read by users with 32-bit Python interpreters.
	THIS IS DEPRECATED CODE AND WILL BE DELETED WHEN ONE OR THE OTHER
	OF THOSE THINGS GOES AWAY.  DO NOT USE.
	"""
	__slots__ = ()
