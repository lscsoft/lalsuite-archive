      ...
      while( tablePtr.simInspiralTable )
      {
        FIRST_TABLE_ROW
          fprintf( xml->fp, SIM_INSPIRAL_ROW,
            ...
            tablePtr.simInspiralTable->fref,
            tablePtr.simInspiralTable->phase_order,
            tablePtr.simInspiralTable->spin_order, 
            tablePtr.simInspiralTable->tidal_order,
            tablePtr.simInspiralTable->deltat, 
            tablePtr.simInspiralTable->frame_axis,
            tablePtr.simInspiralTable->modes_choice,
