      ...
      while( tablePtr.simInspiralTable )
      {
        FIRST_TABLE_ROW
          fprintf( xml->fp, SIM_INSPIRAL_ROW,
              ...
              tablePtr.simInspiralTable->dalpha1,
              tablePtr.simInspiralTable->dalpha2,
              tablePtr.simInspiralTable->dalpha3,
              tablePtr.simInspiralTable->dalpha4,
              tablePtr.simInspiralTable->dalpha5,
              tablePtr.simInspiralTable->dbeta1,
              tablePtr.simInspiralTable->dbeta2,
              tablePtr.simInspiralTable->dbeta3,
              tablePtr.simInspiralTable->dsigma1,
              tablePtr.simInspiralTable->dsigma2,
              tablePtr.simInspiralTable->dsigma3,
              tablePtr.simInspiralTable->dsigma4,
