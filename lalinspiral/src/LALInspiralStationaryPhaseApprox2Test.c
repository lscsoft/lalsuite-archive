...
int
XLALInspiralStationaryPhaseApprox2Test (REAL4Vector      *signalvec,
                                       InspiralTemplate *params)
{ /* </lalVerbatim>  */
   ...
   if ( XLALInspiralChooseModel(&func, &ak, params) == XLAL_FAILURE)
     XLAL_ERROR(XLAL_EFUNC);
    /* fill the dphis array */
   
   dphis[0] = params->dphi0;  
   dphis[1] = params->dphi1;
   dphis[2] = params->dphi2;
   dphis[3] = params->dphi3;
   dphis[4] = params->dphi4;
   dphis[5] = params->dphi5;
   dphis[6] = params->dphi5l;
   dphis[7] = params->dphi6;
   dphis[8] = params->dphi6l;
   dphis[9] = params->dphi7;
