...
def hilbert(params, segment):
    ...
    ifolat,ifolon = pylal.pylal_seismon_utils.getLatLon(params)
    ...
    for attributeDic in attributeDics:
        ...
        xazimuth,yazimuth = pylal.pylal_seismon_utils.getAzimuth(params)
        ...
        for angle in angles:
            ...
            xcorr,lags = pylal.pylal_seismon_utils.xcorr(dataHilbert.data,dataXY.data,maxlags=1)
