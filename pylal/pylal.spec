...
Requires:	python glue glue-segments lal-python lalframe-python lalsimulation-python lalinspiral-python lalburst-python lalmetaio-python numpy scipy python-matplotlib
BuildRequires:  python-devel lal-devel lalmetaio-devel lalframe-devel lalsimulation-devel lalinspiral-devel lalburst-devel lalmetaio-devel numpy pkgconfig
%description
