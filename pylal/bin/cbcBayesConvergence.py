...
def cbcBayesPostProc(
    ...
    #Create array of posterior_samples files
    if nsconvergence and not ns_flag:
	raise RuntimeError('-ns flag must be set to use --nsconvergence')
    elif nsconvergence and ns_flag:	
	import string
	...
	di_evidence_arr = []
		...
		f = open(outdir+'/posterior_samples.dat')
		param_arr = string.split(f.readline())
		loadfile = loadtxt(f)
		pos_samples.append(loadfile)
		f.close()
		#di_evidence_arr.append(pos.di_evidence())
