...
if __name__=='__main__':
    ...
    parser.add_option('--ellipseEvidence', action='store_true', default=False,help='Estimate the evidence by fitting ellipse to highest-posterior points.', dest='ellevidence')
