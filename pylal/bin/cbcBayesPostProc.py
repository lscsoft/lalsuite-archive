...
if __name__=='__main__':
    ...
    massParams=['mtotal','m1','m2','chirpmass','mchirp','mc','eta','q','massratio','asym_massratio','rdmass']
    distParams=['distance','distMPC','dist']
    incParams=['iota','inclination','cosiota']
    polParams=['psi','polarisation','polarization']
    skyParams=['ra','rightascension','declination','dec']
    timeParams=['time']
    spinParams=['spin1','spin2','a1','a2','rdspin','chiEff','phi1','theta1','phi2','theta2','costilt1','costilt2','chi','effectivespin','costheta_jn','cosbeta','tilt1','tilt2','phi_jl','theta_jn','phi12']
    phaseParams=['phase']
    ...
    tigerParams=['dtau21','dtau22','dtau33','dtau44','dfreq21','dfreq22','dfreq33','dfreq44']#['dphi%i'%(i) for i in range(7)] + ['dphi%il'%(i) for i in [5,6] ]
