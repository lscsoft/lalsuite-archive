...
if __name__=='__main__':
    ...
    timeParams=['time']
    spinParams=['spin1','spin2','a1','a2','phi1','theta1','phi2','theta2','costilt1','costilt2','chi','effectivespin','costhetas','cosbeta','tilt1','tilt2','phi_jl','theta_jn','phi12']
    phaseParams=['phase']
