...
if __name__ == "__main__":
    ...
    # TIGER parameters
    if 'dchi0' in samples.dtype.names: injections['dchi0']=samples['dchi0']
    if 'dchi1' in samples.dtype.names: injections['dchi1']=samples['dchi1']
    if 'dchi2' in samples.dtype.names: injections['dchi2']=samples['dchi2']
    if 'dchi3' in samples.dtype.names: injections['dchi3']=samples['dchi3']
    if 'dchi4' in samples.dtype.names: injections['dchi4']=samples['dchi4']
    if 'dchi5' in samples.dtype.names: injections['dchi5']=samples['dchi5']
    if 'dchi5l' in samples.dtype.names: injections['dchi5l']=samples['dchi5l']
    if 'dchi6' in samples.dtype.names: injections['dchi6']=samples['dchi6']
    if 'dchi6l' in samples.dtype.names: injections['dchi6l']=samples['dchi6l']
    if 'dchi7' in samples.dtype.names: injections['dchi7']=samples['dchi7']
    if 'loglambdaG' in samples.dtype.names: injections['loglambdaG']=samples['loglambdaG']
    if 'ScalarCharge1' in samples.dtype.names: injections['ScalarCharge1']=samples['ScalarCharge1']
    if 'ScalarCharge2' in samples.dtype.names: injections['ScalarCharge2']=samples['ScalarCharge2']
    if 'omegaBD' in samples.dtype.names: injections['omegaBD']=samples['omegaBD']
    if 'aPPE' in samples.dtype.names: injections['aPPE']=samples['aPPE']
    if 'alphaPPE' in samples.dtype.names: injections['alphaPPE']=samples['alphaPPE']
    if 'bPPE' in samples.dtype.names: injections['bPPE']=samples['bPPE']
    if 'betaPPE' in samples.dtype.names: injections['betaPPE']=samples['betaPPE']
    if 'betaStep' in samples.dtype.names: injections['betaStep']=samples['betaStep']
    if 'fStep' in samples.dtype.names: injections['fStep']=samples['fStep']
