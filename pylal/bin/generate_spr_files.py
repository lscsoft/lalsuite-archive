   ...
   if opts.dq_cats is None:
     ...
     if opts.roundrobin_number: 
       ...
       for i in range(len(List_of_Glitch_KW_Sets)):
         ...
         output_evaluation=opts.output_tag + "_set_" + str(i) + "_" + "evaluation.pat"
         auxmvc_utils.WriteMVSCTriggers(MVSC_evaluation_set, output_filename = output_evaluation, Classified = False) 
     
         output_training=opts.output_tag + "_set_" + str(i) + "_" + "training.pat"
     ...
     for cats in dq_cats:
       ...
       if opts.roundrobin_number:
         ...
         for i in range(len(List_of_Glitch_KW_Sets_cats)):
           ...
           output_evaluation=cats + "_" + opts.output_tag + "_set_" + str(i) + "_" + "evaluation.pat"
           ...
           output_training=cats + "_" + opts.output_tag + "_set_" + str(i) + "_" + "training.pat"
