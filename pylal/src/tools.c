...
SnglInspiralTable *PySnglInspiral2CSnglInspiral(PyObject *row) {
    ...
    event->end.gpsSeconds = GetAttrLong(row, "end_time");
    event->end.gpsNanoSeconds = GetAttrLong(row, "end_time_ns");
...
SimInspiralTable *PySimInspiral2CSimInspiral(PyObject *row) {
    ...
    event->simulation_id = GetAttrLongLong(row, "simulation_id");
