...
static struct PyMemberDef members[] = {
	...
	{"ds2_H1V1", T_FLOAT, offsetof(pylal_SnglRingdownTable, sngl_ringdown.ds2_H1V1), 0, "ds2_H1V1"},
	{"ds2_H2L1", T_FLOAT, offsetof(pylal_SnglRingdownTable, sngl_ringdown.ds2_H2L1), 0, "ds2_H2L1"},
	{"ds2_H2V1", T_FLOAT, offsetof(pylal_SnglRingdownTable, sngl_ringdown.ds2_H2V1), 0, "ds2_H2V1"},
	{"ds2_L1V1", T_FLOAT, offsetof(pylal_SnglRingdownTable, sngl_ringdown.ds2_L1V1), 0, "ds2_L1V1"},
