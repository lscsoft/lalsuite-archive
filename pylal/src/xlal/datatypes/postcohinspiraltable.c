...
static struct PyMemberDef members[] = {
	...
	{"fap_h", T_FLOAT, offsetof(pylal_PostcohInspiralTable, postcoh_inspiral.fap), 0, "fap_h"},
	{"fap_l", T_FLOAT, offsetof(pylal_PostcohInspiralTable, postcoh_inspiral.fap), 0, "fap_l"},
	{"fap_v", T_FLOAT, offsetof(pylal_PostcohInspiralTable, postcoh_inspiral.fap), 0, "fap_v"},
	{"far", T_FLOAT, offsetof(pylal_PostcohInspiralTable, postcoh_inspiral.far), 0, "far"},
	{"far_h", T_FLOAT, offsetof(pylal_PostcohInspiralTable, postcoh_inspiral.far), 0, "far_h"},
	{"far_l", T_FLOAT, offsetof(pylal_PostcohInspiralTable, postcoh_inspiral.far), 0, "far_l"},
	{"far_v", T_FLOAT, offsetof(pylal_PostcohInspiralTable, postcoh_inspiral.far), 0, "far_v"},
