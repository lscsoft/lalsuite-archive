...
class test_LIGOTimeGPS(unittest.TestCase):
    ...
    def test__neg__(self):
        self.assertEqual(LIGOTimeGPS(-3),-LIGOTimeGPS(3))
        
    def testns(self):
        new=LIGOTimeGPS(100.56)
        self.assertEqual(new.gpsSeconds.value*1e9+new.gpsNanoSeconds.value,new.ns())

    def test__abs__(self):
        self.assertEqual(abs(LIGOTimeGPS(-300.0)),abs(LIGOTimeGPS(300.0)))
