...
setup(
	...
	scripts = [
		...
		os.path.join("bin", "pylal_grb_incexclusions"),
		os.path.join("bin", "pylal_grblikelihood"),
		os.path.join("bin", "pylal_grblikelihood_inclination"),
		os.path.join("bin", "pylal_grbUL"),
		os.path.join("bin", "pylal_grbUL_inclination"),
		os.path.join("bin", "pylal_grbtimeslide_stats"),
		os.path.join("bin", "pylal_query_dq"),
		os.path.join("bin", "pylal_relic"),
		os.path.join("bin", "pylal_relic_inclination"),
