...
setup(
	...
	ext_modules = [
		...
		Extension(
			...
			extra_compile_args = ["-std=gnu99", "-fopenmp", "-ffast-math", "-mfpmath=387", "-O3"] + gsl_pkg_config.extra_cflags + lalsimulation_pkg_config.extra_cflags + lal_pkg_config.extra_cflags,
