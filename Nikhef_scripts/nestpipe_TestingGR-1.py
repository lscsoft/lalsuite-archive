...
postprocfolder = "/home/salvatore.vitale/public_html/IMR_runs/%s/%s"%(type_name,inspinj_seed)       ## You only need to change the path leaving the last two levels are they are (i.e. /%s/%s). The code will add the seed and the type of run (GR or tested param +value of the shift)
...
"""
	...
	os.system("cp "+curdir+"/"+xmlname+" "+basefolder+foldername)
        os.system("lalapps_nest_pipe_reduced -i "+ basefolder+foldername+"/"+parsername+ " -I "+basefolder+foldername+"/"+xmlname+ " -r " + basefolder+foldername + "")
	#os.system("lalapps_nest_pipe_reduced -i "+ basefolder+foldername+"/"+parsername+ " -I "+basefolder+foldername+"/"+xmlname+ " -r " + basefolder+foldername + " --condor-submit")
