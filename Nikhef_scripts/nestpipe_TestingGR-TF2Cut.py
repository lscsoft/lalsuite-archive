...
shift=2.5            ## This is in percent. If type_inj is GR this will be ignored (you don't need to set it to zero or empty string)
...
basefolder = "/home/magathos/TF2Cut/%s/%s"%(type_name,inspinj_seed)                       ##
postprocfolder = "/home/magathos/public_html/TF2Cut/%s/%s"%(type_name,inspinj_seed)       ##
scratchdir = "/scratch/magathos/TF2Cut/%s/%s"%(type_name,inspinj_seed)            ##
logdir = "/people/magathos/TF2Cut/%s/%s"%(type_name,inspinj_seed)                  ## logdir and scratchdir are ignored in all the clusters but UWM.                 
