...
#remote_database='TF2Spins_db.txt'   ## Succesful runs are appended to remote_database. Failed runs are appended to 'remote_database'_failed
...
PATH_TO_OPT="/home/magathos/lalsuites/optSTU"  ## Path to the opt folder of your installation

basefolder = "/home/magathos/Rec3PN/%s/%s"%(type_name,inspinj_seed)                       ##
postprocfolder = "/home/magathos/public_html/Rec3PN/%s/%s"%(type_name,inspinj_seed)       ##
scratchdir = "/scratch/magathos/Rec3PN/%s/%s"%(type_name,inspinj_seed)            ##
logdir = "/people/magathos/Rec3PN/%s/%s"%(type_name,inspinj_seed)                  ## logdir and scratchdir are ignored in all the clusters but UWM.                 
