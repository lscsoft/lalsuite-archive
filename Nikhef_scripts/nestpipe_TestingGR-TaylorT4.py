...
basefolder = "/home/vdbroeck/TaylorT4_TaylorF2/TaylorT4inj/%s/%s"%(type_name,inspinj_seed)                       ##
postprocfolder = "/home/vdbroeck/WWW/TaylorT4_TaylorF2/TaylorT4inj/%s/%s"%(type_name,inspinj_seed)       ##
scratchdir = "/scratch/vdbroeck/TaylorT4_TaylorF2/TaylorT4inj/%s/%s"%(type_name,inspinj_seed)            ##
logdir = "/people/vdbroeck/TaylorT4_TaylorF2/TaylorT4inj/%s/%s"%(type_name,inspinj_seed)                  ## logdir and scratchdir are ignored in all the clusters but UWM.                 
